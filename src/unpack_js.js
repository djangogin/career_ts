! function(t, e) {
	...
	t.OrgChart = class {
		constructor() {
            ...
            <code>chart.nodeContent({data}=>{ <br/>
             ...
             Or check different <a href="https://github.com/bumbeishvili/org-chart#jump-to-examples" target="_blank">layout examples</a>
				...
				buttonContent: ({
					...
					return `<div style="border:1px solid #E4E2E9;border-radius:3px;padding:3px;font-size:9px;margin:auto auto;background-color:white"> ${{left:t=>t?` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M14.283 3.50094L6.51 11.4749C6.37348 11.615 6.29707 11.8029 6.29707 11.9984C6.29707 12.194 6.37348 12.3819 6.51 12.5219L14.283 20.4989C14.3466 20.5643 14.4226 20.6162 14.5066 20.6516C14.5906 20.6871 14.6808 20.7053 14.772 20.7053C14.8632 20.7053 14.9534 20.6871 15.0374 20.6516C15.1214 20.6162 15.1974 20.5643 15.261 20.4989C15.3918 20.365 15.4651 20.1852 15.4651 19.9979C15.4651 19.8107 15.3918 19.6309 15.261 19.4969L7.9515 11.9984L15.261 4.50144C15.3914 4.36756 15.4643 4.18807 15.4643 4.00119C15.4643 3.81431 15.3914 3.63482 15.261 3.50094C15.1974 3.43563 15.1214 3.38371 15.0374 3.34827C14.9534 3.31282 14.8632 3.29456 14.772 3.29456C14.6808 3.29456 14.5906 3.31282 14.5066 3.34827C14.4226 3.38371 14.3466 3.43563 14.283 3.50094V3.50094Z" fill="#716E7B" stroke="#716E7B"/>
                      </svg></span> < span style = "color:#716E7B" > $ {
						e.data._directSubordinatesPaging
					} < /span></div > `:` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						e.data._directSubordinatesPaging
					} < /span></div > `,bottom:t=>t?` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                       ...
                       </svg></span> < span style = "margin-left:1px;color:#716E7B" > $ {
						e.data._directSubordinatesPaging
					} < /span></div > `:` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M11.457 8.07005L3.49199 16.4296C3.35903 16.569 3.28485 16.7543 3.28485 16.9471C3.28485 17.1398 3.35903 17.3251 3.49199 17.4646L3.50099 17.4736C3.56545 17.5414 3.64304 17.5954 3.72904 17.6324C3.81504 17.6693 3.90765 17.6883 4.00124 17.6883C4.09483 17.6883 4.18745 17.6693 4.27344 17.6324C4.35944 17.5954 4.43703 17.5414 4.50149 17.4736L12.0015 9.60155L19.4985 17.4736C19.563 17.5414 19.6405 17.5954 19.7265 17.6324C19.8125 17.6693 19.9052 17.6883 19.9987 17.6883C20.0923 17.6883 20.1849 17.6693 20.2709 17.6324C20.3569 17.5954 20.4345 17.5414 20.499 17.4736L20.508 17.4646C20.641 17.3251 20.7151 17.1398 20.7151 16.9471C20.7151 16.7543 20.641 16.569 20.508 16.4296L12.543 8.07005C12.4729 7.99653 12.3887 7.93801 12.2954 7.89801C12.202 7.85802 12.1015 7.8374 12 7.8374C11.8984 7.8374 11.798 7.85802 11.7046 7.89801C11.6113 7.93801 11.527 7.99653 11.457 8.07005Z" fill="#716E7B" stroke="#716E7B"/>
						...
						e.data._directSubordinatesPaging
					} < /span></div > `,right:t=>t?` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M7.989 3.49944C7.85817 3.63339 7.78492 3.8132 7.78492 4.00044C7.78492 4.18768 7.85817 4.36749 7.989 4.50144L15.2985 11.9999L7.989 19.4969C7.85817 19.6309 7.78492 19.8107 7.78492 19.9979C7.78492 20.1852 7.85817 20.365 7.989 20.4989C8.05259 20.5643 8.12863 20.6162 8.21261 20.6516C8.2966 20.6871 8.38684 20.7053 8.478 20.7053C8.56916 20.7053 8.6594 20.6871 8.74338 20.6516C8.82737 20.6162 8.90341 20.5643 8.967 20.4989L16.74 12.5234C16.8765 12.3834 16.9529 12.1955 16.9529 11.9999C16.9529 11.8044 16.8765 11.6165 16.74 11.4764L8.967 3.50094C8.90341 3.43563 8.82737 3.38371 8.74338 3.34827C8.6594 3.31282 8.56916 3.29456 8.478 3.29456C8.38684 3.29456 8.2966 3.31282 8.21261 3.34827C8.12863 3.38371 8.05259 3.43563 7.989 3.50094V3.49944Z" fill="#716E7B" stroke="#716E7B"/>
                       </svg></span> < span style = "color:#716E7B" > $ {
						e.data._directSubordinatesPaging
					} < /span></div > `:` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M14.283 3.50094L6.51 11.4749C6.37348 11.615 6.29707 11.8029 6.29707 11.9984C6.29707 12.194 6.37348 12.3819 6.51 12.5219L14.283 20.4989C14.3466 20.5643 14.4226 20.6162 14.5066 20.6516C14.5906 20.6871 14.6808 20.7053 14.772 20.7053C14.8632 20.7053 14.9534 20.6871 15.0374 20.6516C15.1214 20.6162 15.1974 20.5643 15.261 20.4989C15.3918 20.365 15.4651 20.1852 15.4651 19.9979C15.4651 19.8107 15.3918 19.6309 15.261 19.4969L7.9515 11.9984L15.261 4.50144C15.3914 4.36756 15.4643 4.18807 15.4643 4.00119C15.4643 3.81431 15.3914 3.63482 15.261 3.50094C15.1974 3.43563 15.1214 3.38371 15.0374 3.34827C14.9534 3.31282 14.8632 3.29456 14.772 3.29456C14.6808 3.29456 14.5906 3.31282 14.5066 3.34827C14.4226 3.38371 14.3466 3.43563 14.283 3.50094V3.50094Z" fill="#716E7B" stroke="#716E7B"/>
						...
						e.data._directSubordinatesPaging
					} < /span></div > `,top:t=>t?` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M11.457 8.07005L3.49199 16.4296C3.35903 16.569 3.28485 16.7543 3.28485 16.9471C3.28485 17.1398 3.35903 17.3251 3.49199 17.4646L3.50099 17.4736C3.56545 17.5414 3.64304 17.5954 3.72904 17.6324C3.81504 17.6693 3.90765 17.6883 4.00124 17.6883C4.09483 17.6883 4.18745 17.6693 4.27344 17.6324C4.35944 17.5954 4.43703 17.5414 4.50149 17.4736L12.0015 9.60155L19.4985 17.4736C19.563 17.5414 19.6405 17.5954 19.7265 17.6324C19.8125 17.6693 19.9052 17.6883 19.9987 17.6883C20.0923 17.6883 20.1849 17.6693 20.2709 17.6324C20.3569 17.5954 20.4345 17.5414 20.499 17.4736L20.508 17.4646C20.641 17.3251 20.7151 17.1398 20.7151 16.9471C20.7151 16.7543 20.641 16.569 20.508 16.4296L12.543 8.07005C12.4729 7.99653 12.3887 7.93801 12.2954 7.89801C12.202 7.85802 12.1015 7.8374 12 7.8374C11.8984 7.8374 11.798 7.85802 11.7046 7.89801C11.6113 7.93801 11.527 7.99653 11.457 8.07005Z" fill="#716E7B" stroke="#716E7B"/>
                        </svg></span> < span style = "margin-left:1px;color:#716E7B" > $ {
						e.data._directSubordinatesPaging
					} < /span></div > `:` < div style = "display:flex;" > <span style="align-items:center;display:flex;"><svg width="8" height="8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						e.data._directSubordinatesPaging
					} < /span></div > `}[t.layout](e.children)}  </div>`
				},
				...
				linkUpdate: function(t, e, a) {
					u.select(this).attr("stroke", t => t.data._upToTheRootHighlighted ? "#E27396" : "#E4E2E9").attr("stroke-width", t => t.data._upToTheRootHighlighted ? 5 : 1), t.data._upToTheRootHighlighted && u.select(this).raise()
				},
				hdiagonal: function(t, e, a) {
					var n = t.x,
						...
						l = (Math.abs(e - t), Math.abs(i - n) / 2 - s);
					return `
                          M ${o} ${a}
                          L ${o} ${t}
                          L ${n} ${t}
               ...
               `
				...
				defs: function(a, t) {
					return `<defs>
                    ${t.map(t=>{var e=this.getTextWidth(t.label,{ctx:a.ctx,fontSize:2,defaultFont:a.defaultFont});return` < marker id = "${t.from+"
					_ "+t.to}"
					refX = "${t._source.x<t._target.x?-7:7}"
					refY = "5"
					markerWidth = "500"
					markerHeight = "500"
					orient = "${t._source.x<t._target.x?"
					auto ":"
					auto - start - reverse "}" > < rect rx = 0.5 width = $ {
						t.label ? e + 3 : 0
					}
					height = 3 y = 1 fill = "#E27396" > < /rect> < text font - size = "2px"
					x = 1 fill = "white"
					y = 3 > $ {
						t.label || ""
					} < /text> < /marker> < marker id = "arrow-${t.from+"
					_ "+t.to}"
					markerWidth = "500"
					markerHeight = "500"
					refY = "2"
					...
					orient = "${t._source.x<t._target.x?"
					auto ":"
					auto - start - reverse "}" > <path transform="translate(0)" d='M0,0 V4 L2,2 Z' fill='#E27396' /> < /marker>
					`}).join("")}
                    </defs>
                    `
				},
			...
			this.getChartState = () => a, Object.keys(a).forEach(e => {
				this[e] = function(t) {
		...
		render() {
			...
			if(o.data && 0 != o.data.length) {
				...
				(o.calc = a).centerX = a.chartWidth / 2, a.centerY = a.chartHeight / 2, o.firstDraw && ((e = {
					zoom: null
				}).zoom = u.zoom().on("start", (t, e) => o.onZoomStart(t, e)).on("end", (t, e) => o.onZoomEnd(t, e)).on("zoom", (t, e) => {
					o.onZoom(t, e),
					this.zoomed(t, e)
				}).scaleExtent(o.scaleExtent), o.zoomBehavior = e.zoom), o.flexTreeLayout = r.flextree({
					nodeSize: t => {
						var e = o.nodeWidth(t),
							a = o.nodeHeight(t),
				...
				}).spacing((t, e) => t.parent == e.parent ? 0 : o.neighbourMargin(t, e)), this.setLayouts({
					expandNodesFirst: !1
				});
				e = t.patternify({
					tag: "svg",
					selector: "svg-chart-container"
				}).attr("width", o.svgWidth).attr("height", o.svgHeight).attr("font-family", o.defaultFont), t = (o.firstDraw && e.call(o.zoomBehavior).on("dblclick.zoom", null).attr("cursor", "move"), (o.svg = e).patternify({
					tag: "g",
					selector: "chart"
				}));
				...
				})), o.chart = t, this.update(o.root), u.select(window).on("resize." + o.id, () => {
					var t = u.select(o.container).node().getBoundingClientRect();o.svg.attr("width", t.width)
				}), o.firstDraw && (o.firstDraw = !1)
			} else console.log("ORG CHART - Data is empty");
			return this
		}
		addNode(e) {
			const a = this.getChartState();
			var t = a.allNodes.filter(({
					data: t
				}) => a.nodeId(t) === a.nodeId(e))[0],
				n = a.allNodes.filter(({
					data: t
				}) => a.nodeId(t) === a.parentNodeId(e))[0];
			return t ? console.log(`ORG CHART - ADD - Node with id "${a.nodeId(e)}" already exists in tree`) : n ? (e._centered && !e._expanded && (e._expanded = !0), a.data.push(e), this.updateNodesState()) : console.log(`ORG CHART - ADD - Parent node with id "${a.parentNodeId(e)}" not found in the tree`), this
		}
		removeNode(e) {
			const a = this.getChartState();
			var t = a.allNodes.filter(({
			...
			return t ? (t.descendants().forEach(t => t.data._filteredOut = !0), this.getNodeChildren(t, [], a.nodeId).forEach(t => t._filtered = !0), a.data = a.data.filter(t => !t._filtered), this.updateNodesState.bind(this)()) : console.log(`ORG CHART - REMOVE - Node with id "${e}" not found in the tree`), this
		}
		groupBy(t, a, e) {
			const n = {};
			return t.forEach(t => {
		...
		update({
			...
			var t = s.flexTreeLayout(s.root),
				e = (s.compact && this.calculateCompactFlexPositions(s.root), t.descendants()),
				t = t.descendants().slice(1),
				l = (e.forEach(s.layoutBindings[s.layout].swap), s.connections);
			const h = {},
				c = (s.allNodes.forEach(t => h[s.nodeId(t.data)] = t), {});
			e.forEach(t => c[s.nodeId(t.data)] = t), l.forEach(t => {
				var e = h[t.from],
					a = h[t.to];t._source = e,
				t._target = a
			});
			var l = l.filter(t => c[t.from] && c[t.to]),
				g = s.defs.bind(this)(s, l),
				g = (g !== s.defsWrapper.html() && s.defsWrapper.html(g), s.linksWrapper.selectAll("path.link").data(t, t => s.nodeId(t.data))),
				...
				t = (t.attr("fill", "none"), this.isEdge() ? t.style("display", t => {
					return t.data._pagingButton ? "none" : "auto"
				}) : t.attr("display", t => {
					return t.data._pagingButton ? "none" : "auto"
				}), t.each(s.linkUpdate), t.transition().duration(s.duration).attr("d", t => {
				...
				}).remove(), s.connectionsWrapper.selectAll("path.connection").data(l)),
				...
				l = (g.attr("fill", "none"), g.transition().duration(s.duration).attr("d", t => {
				...
				}), g.each(s.connectionsUpdate), t.exit().transition().duration(s.duration).attr("opacity", 0).remove(), s.nodesWrapper.selectAll("g.node").data(e, ({
					data: t
				}) => s.nodeId(t))),
				g = l.enter().append("g").attr("class", "node").attr("transform", t => {
					return t == s.root ? `translate(${a},${n})` : `translate(${s.layoutBindings[s.layout].nodeJoinX({x:a,y:n,width:r,height:d})},${s.layoutBindings[s.layout].nodeJoinY({x:a,y:n,width:r,height:d})})`
				}).attr("cursor", "pointer").on("click", (t, e) => {
					var a = e["data"];
					[...t.srcElement.classList].includes("node-button-foreign-object") || ([...t.srcElement.classList].includes("paging-button-wrapper") ? this.loadPagingNodes(e) : a._pagingButton ? console.log("event fired, no handlers") : (s.onNodeClick(a), console.log("node clicked")))
				}),
				t = (g.patternify({
					tag: "rect",
					selector: "node-rect",
				...
				g = (t.patternify({
					...
					data: t => [t]
				}), this.restyleForeignObjectElements(), g.patternify({
					tag: "g",
				...
				g = (g.patternify({
					...
					data: t => [t]
				}).attr("opacity", 0).attr("pointer-events", "all").attr("width", t => s.nodeButtonWidth(t)).attr("height", t => s.nodeButtonHeight(t)).attr("x", t => s.nodeButtonX(t)).attr("y", t => s.nodeButtonY(t)), g.patternify({
					tag: "foreignObject",
					...
					data: t => [t]
				}).style("pointer-events", "none").style("display", "flex").style("width", "100%").style("height", "100%"), t.transition().attr("opacity", 0).duration(s.duration).attr("transform", ({
					x: t,
					y: e,
					width: a,
					height: n
				}) => s.layoutBindings[s.layout].nodeUpdateTransform({
					x: t,
					y: e,
					width: a,
					height: n
				})).attr("opacity", 1), t.select(".node-rect").attr("width", ({
					width: t
				}) => t).attr("height", ({
					height: t
				}) => t).attr("x", ({}) => 0).attr("y", ({}) => 0).attr("cursor", "pointer").attr("rx", 3).attr("fill", s.nodeDefaultBackground), t.select(".node-button-g").attr("transform", ({
					width: t,
					height: e
				}) => {
					...
					data: t
				}) => 0 < t._directSubordinates ? null : "none").attr("opacity", ({
					data: t,
					children: e,
					_children: a
				}) => !t._pagingButton && (e || a) ? 1 : 0), t.select(".node-button-foreign-object .node-button-div").html(t => s.buttonContent({
					node: t,
					state: s
				})), t.select(".node-button-text").attr("text-anchor", "middle").attr("alignment-baseline", "middle").attr("font-size", ({
					children: t
				}) => t ? 40 : 26).text(({
					children: t
				}) => t ? "-" : "+").attr("y", this.isEdge() ? 10 : 0), t.each(s.nodeUpdate), l.exit().attr("opacity", 1).transition().duration(s.duration).attr("transform", t => {
					return `translate(${s.layoutBindings[s.layout].nodeJoinX({x:i,y:o,width:r,height:d})},${s.layoutBindings[s.layout].nodeJoinY({x:i,y:o,width:r,height:d})})`
				}).on("end", function() {
					u.select(this).remove()
				}).attr("opacity", 0), e.forEach(t => {
					t.x0 = t.x,
					t.y0 = t.y
		...
		restyleForeignObjectElements() {
			...
			n.svg.selectAll(".node-foreign-object").attr("width", ({
				width: t
			}) => t).attr("height", ({
				height: t
			}) => t).attr("x", ({}) => 0).attr("y", ({}) => 0), n.svg.selectAll(".node-foreign-object-div").style("width", ({
				width: t
			}) => t + "px").style("height", ({
				height: t
			}) => t + "px").html(function(t, e, a) {
		...
		onButtonClick(t, e) {
			...
			e.data._pagingButton || (a.setActiveNodeCentered && (e.data._centered = !0, e.data._centeredWithDescendants = !0), e.children ? (e._children = e.children, e.children = null, this.setExpansionFlagToChildren(e, !1)) : (e.children = e._children, e._children = null, e.children && e.children.forEach(({
				data: t
			}) => t._expanded = !0)), this.update(e))
		}
		...
		expandSomeNodes(e) {
			if(e.data._expanded) {
				let t = e.parent;
				for(; t;) t._children && (t.children = t._children), t = t.parent
			}
		...
		setLayouts({
			...
			}), o.root = u.stratify().id(t => o.nodeId(t)).parentId(t => o.parentNodeId(t))(o.data.filter(t => !0 !== n[t.id])), o.root.each((t, e, a) => {
				var n = o.nodeWidth(t),
					i = o.nodeHeight(t);Object.assign(t, {
					width: n,
					height: i
				})
			}), o.root.x0 = 0, o.root.y0 = 0, o.allNodes = o.root.descendants(), o.allNodes.forEach(t => {
				Object.assign(t.data, {
					_directSubordinates: t.children ? t.children.length : 0,
					_totalSubordinates: t.descendants().length - 1
				})
			}), o.root.children && (t && o.root.children.forEach(this.expand), o.root.children.forEach(t => this.collapse(t)), 0 == o.expandLevel && (o.root._children = o.root.children, o.root.children = null), [o.root].forEach(t => this.expandSomeNodes(t)))
		}
		collapse(t) {
		...
		zoomTreeBounds({
			...
			var {
				...
				duration: h,
				lastTransform: c
			} = this.getChartState(), g = Math.min(8, .9 / Math.max((e - t) / r, (n - a) / d));
			let p = u.zoomIdentity.translate(r / 2, d / 2);
			p = (p = p.scale(i.scale ? g : c.k)).translate(-(t + e) / 2, -(a + n) / 2), s.transition().duration(i.animate ? h : 0).call(l.transform, p), o.transition().duration(i.animate ? h : 0).attr("transform", "translate(0,0)")
		}
		fit({
			animate: t = !0,
			nodes: e,
		...
		loadPagingNodes(t) {
			var e = this.getChartState(),
				a = (t.data._pagingButton = !1, t.parent.data._pagingStep),
				e = e.pagingStep(t.parent);
			t.parent.data._pagingStep = a + e, console.log("loading paging nodes", t), this.updateNodesState()
		}
		setExpanded(e, t = !0) {
			const a = this.getChartState();
			var n = a.allNodes.filter(({
				data: t
			}) => a.nodeId(t) == e)[0];
			return n ? n.data._expanded = t : console.log(`ORG CHART - ${t?"EXPAND":"COLLAPSE"} - Node with id (${e})  not found in the tree`), this
		}
		setCentered(e) {
			const a = this.getChartState();
			var t = a.allNodes.filter(t => a.nodeId(t.data) === e)[0];
			return t ? (t.data._centered = !0, t.data._expanded = !0) : console.log(`ORG CHART - CENTER - Node with id (${e}) not found in the tree`), this
		}
		setHighlighted(e) {
			const a = this.getChartState();
			var t = a.allNodes.filter(t => a.nodeId(t.data) === e)[0];
			return t ? (t.data._highlighted = !0, t.data._expanded = !0, t.data._centered = !0) : console.log(`ORG CHART - HIGHLIGHT - Node with id (${e})  not found in the tree`), this
		}
		setUpToTheRootHighlighted(e) {
			const a = this.getChartState();
			var t = a.allNodes.filter(t => a.nodeId(t.data) === e)[0];
			return t ? (t.data._upToTheRootHighlighted = !0, t.data._expanded = !0, t.ancestors().forEach(t => t.data._upToTheRootHighlighted = !0)) : console.log(`ORG CHART - HIGHLIGHTROOT - Node with id (${e}) not found in the tree`), this
		}
		clearHighlighting() {
			var t = this.getChartState();
		...
		exportImg({
			...
			const c = () => {
				...
				var t = r.duration();a && r.fit();
				const e = r.getChartState()["svg"];setTimeout(t => {
					r.downloadImage({
						node: e.node(),
						scale: n,
						isSvg: !1,
		...
		expandAll() {
			...
			return t.forEach(t => t.data._expanded = !0), this.render(), this
		}
		collapseAll() {
			var t = this.getChartState()["allNodes"];
			return t.forEach(t => t.data._expanded = !1), this.expandLevel(0), this.render(), this
		}
		downloadImage({
			node: t,
			scale: e = 2,
			...
			isSvg: a = !1,
			save: i = !0,
			onAlreadySerialized: o = t => {},
			onLoad: r = t => {}
		}) {
			const d = t;
			if(a) t = '<?xml version="1.0" standalone="no"?>\r\n' + (t = h(d)), l(s = "data:image/svg+xml;charset=utf-8," + encodeURIComponent(t), n + ".svg"), o();
			else {
				const c = e,
				...
				g.onload = function() {
					var t = document.createElement("canvas"),
						...
						a = (t.width = e.width * c, t.height = e.height * c, t.getContext("2d")),
						a = (a.fillStyle = "#FAFAFA", a.fillRect(0, 0, e.width * c, e.height * c), a.drawImage(g, 0, 0, e.width * c, e.height * c), t.toDataURL("image/png"));
					r && r(a), i && l(a, n + ".png")
				};
				...
				function h(t) {
					for(var e = "http://www.w3.org/2000/xmlns/", a = (t = t.cloneNode(!0), window.location.href + "#"), n = document.createTreeWalker(t, NodeFilter.SHOW_ELEMENT, null, !1); n.nextNode();)
						for(const i of n.currentNode.attributes) i.value.includes(a) && (i.value = i.value.replace(a, "#"));
					return t.setAttributeNS(e, "xmlns", "http://www.w3.org/2000/svg"), t.setAttributeNS(e, "xmlns:xlink", "http://www.w3.org/1999/xlink"), (new XMLSerializer).serializeToString(t)
				}
				o(), g.src = s
			}
		}
